...
class Client_PG extends Client {
  ...
  _acquireOnlyConnection(connectionSettings = this.connectionSettings) {
    const connection = new this.driver.Client(connectionSettings);
  ...
  acquireRawConnection(connectionSettings) {
    ...
    return this._acquireOnlyConnection(connectionSettings)
  ...
  async cancelQuery(connectionToKill) {
    const conn = await this.acquireRawConnection(
      connectionToKill && connectionToKill.__knexConnectionSettings
    );
